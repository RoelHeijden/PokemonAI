...
def main():
    ...
    # embedder.create_model(dims=8)

    # embedder.test_embeddings(SPECIES, 10, dims=32)
    # embedder.test_embeddings(ITEMS, 10, dims=32)
    # embedder.test_embeddings(MOVES, 10, dims=32)
    # embedder.test_embeddings(ABILITIES, 10, dims=32)
...
class Embedder:
    ...
    def create_model(self, file_name='sents_per_poke.txt', dims=32):
        sents_file = os.path.join(self.sents_folder, file_name)
    ...
    def test_embeddings(self, category, n, dims=32):
